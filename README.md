# PPGEEC2327 - Tópicos Especiais em Processamento Inteligente da Informação
...
- 📁 **Projeto 2 | Previsão com Machine Learning vs. Estatística** - Tem como objetivo comparar o desempenho de modelos de **Machine Learning** frente a métodos estatísticos clássicos. Neste estudo, foi utilizada uma rede neural **LSTM** para capturar padrões não lineares e contrastar os resultados com o modelo **ARIMA**, que foi identificado no projeto anterior como o método estatístico mais adequado para esta série. ([Ver Projeto 2](./projeto_2))
